...
namespace TestableHttpClient.IntegrationTests
{
    public class UsingIHttpClientFactory
    {
        ...
        public async Task ConfigureMultipleHttpMessageHandlers()
        {
            ...
            // And use it.
            var result = await githubClient.GetAsync("https://github.com/api/users").ConfigureAwait(false);
            ...
            // And use it...
            result = await httpbinClient.GetAsync("https://httpbin.com/get").ConfigureAwait(false);
        ...
        public async Task ConfigureViaConfigureTestServicesOnHostBuilder()
        {
            ...
            _ = await client.GetAsync("/").ConfigureAwait(false);
        ...
        private class StartUpWithDefaultHttpHandler
        {
            ...
            public static void Configure(IApplicationBuilder app)
            {
                app.Run(async context =>
                {
                    ...
                    await httpClient.GetAsync("https://httpbin.com/get").ConfigureAwait(false);
                    await context.Response.WriteAsync("Hello").ConfigureAwait(false);
                });
            }
        }
    }
